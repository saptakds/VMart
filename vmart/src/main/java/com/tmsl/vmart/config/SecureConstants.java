...
public class SecureConstants {
	...
	public static String HERE_MAPS_API_KEY="wvO1Vd9EPBy8IwESpGlRq-Bx0Lke1jOBrq8AceJ2CnA";
//	public static String HERE_MAPS_API_KEY = "0tz8q1NNO9GZfXs0ubtbcX4BRYbivHWhR_oUVya7By8";
